...
> [PRIVACY.md](PRIVACY.md). MIT licensed — see [LICENSE](LICENSE).
...
|---|---|
| ![Pack gallery](docs/screenshots/packs-gallery.png) | ![Pack example viewer](docs/screenshots/pack-viewer.png) |
...
[docs/MCPB.md](docs/MCPB.md).

**Developers (from a clone):** `./bootstrap.sh` then `./run_hub.sh`. Tests:
`python3 -m pytest tests/ -q` (in-process, no bound ports).

See [SELRAN_HUB_DESIGN.md](SELRAN_HUB_DESIGN.md) for the full specification and
roadmap, and [ops/P3-PLAN.md](ops/P3-PLAN.md) for the installer build pipeline.
...
MIT — © 2026 Selran, Aidin Eslampour. Privacy: [PRIVACY.md](PRIVACY.md).
